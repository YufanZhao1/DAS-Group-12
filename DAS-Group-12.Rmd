...
Here, in this project, we are trying to answer the question "What influence do different features of coffee have on whether the quality of a batch of coffee is classified
as good or poor?"  
...
Inorder to get a clear picture of which countries coffee beans are mostly of good and bad quality, we can plot the quality based on the country of origin in gradient scale.
...
As we can see, category 2 type defects were more in poor quality coffee beans.
...
As we can see, if we consider the country of origin, that would be way too many explanatory variables. So, lets remove that particular variable and fit the model again.
